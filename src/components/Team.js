      ...
      <div className="row">
          <div className="col-lg-8 mx-auto">
            <div className="section-heading">
              <h2 className="section__title">Nos formateurs en Allemand</h2>
